...
module.exports = new Component({
    customId: 'watchparty-episode-torrent-select',
    type: 'select',
    /**
     * 
    ...
    run: async (client, interaction) => {
        ...
        try {
            ...
            const torrentIndex = parseInt(parts[3]);
            ...
            const finalEmbed = new EmbedBuilder()
                ...
                .setTitle(`✅ ${movieData.displayTitle}`)
                ...
                .addFields(
                    { name: '\u200B', value: '**━━━━━━━━━━━━━━━━━━━━**' }, // Divider
                    { name: '📺 Episode Information', value: '\u200B' },
                    { name: '🎬 Show', value: `\`\`\`${movieData.title}\`\`\``, inline: true },
                    { name: '📺 Episode', value: `\`\`\`S${movieData.season}E${movieData.episode}\`\`\``, inline: true },
                    { name: '⭐ Rating', value: `\`\`\`${movieData.imdbRating}/10\`\`\``, inline: true },
                    { name: '\u200B', value: '\u200B' }, // Spacer
            ...
            console.error('Error in episode torrent select:', error);
            await interaction.editReply({

const config = {
    ...
    users: {
        ownerId: '706984059183693854', // The bot owner ID, which is you.
        developers: ['706984059183693854', 'Another account ID'] // The bot developers, remember to include your account ID with the other account IDs.
    },
